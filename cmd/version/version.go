...
// NewVersionCommand creates a "version" Cobra command that prints the crane and crane-lib versions.
// The supplied GlobalFlags are used for flags parsed by Cobra; Viper unmarshals configuration into
// the command's merged global flags prior to execution.
