...
// NewClusterScopeHandler creates a new ClusterScopeHandler used for cluster-scoped RBAC handling.
// It returns a pointer to an initialized, empty ClusterScopeHandler.
...
// isClusterScopedResource reports whether the provided apiGroup and kind identify a resource
// that is admitted for cluster-scoped processing.
...
// NewClusterScopedRbacHandler creates a ClusterScopedRbacHandler with the provided logger,
// readyToFilter set to false, and an initialized empty clusterResources map.
