...
// The provided GlobalFlags `f` are used to initialize the command's Options; the command binds flags into viper during PreRun and runs Options.Complete, Options.Validate, and Options.Run in RunE.
