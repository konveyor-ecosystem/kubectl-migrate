...
// NewListPluginsCommand returns a configured Cobra command that lists configured plugins.
// The command initializes Options with the provided global flags, binds and unmarshals flags via viper in PreRun, and runs Complete, Validate, then Run in RunE. It inherits flags from parent PersistentFlags.
