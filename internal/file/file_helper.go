...
// ReadFiles traverses the directory tree rooted at dir and returns a slice of File
// for each YAML file parsed into an unstructured.Unstructured object.
// It skips directories named "failures" and returns an error if any filesystem or parse
// operation fails.
...
// readFiles recursively traverses the provided file entries under path, skipping any
// directory named "failures", reads each file as YAML, converts it to JSON, unmarshals
// it into an unstructured.Unstructured, and returns a slice of File representing each
// successfully parsed file. Any I/O or parsing error encountered is returned immediately.
